...
_Scaffold — no subprojects yet (repository currently holds licensing/metadata only). Structure will be filled in as the kit is built out._
...
- **Jira:** `CLUS`
- **Related:** Quickring Courier (QR-20)
